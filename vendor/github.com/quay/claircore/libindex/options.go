...
type Options struct {
	...
	// LayerFetchOpt are options for how we store layers we fetch remotely. see LayerFetchOpt
	// type def above for more details.
	...
	// Migrations set to true to have libindex check and potentially run migrations
	Migrations bool
	...
	// vscnrs is a convenience method for holding a list of versioned scanners
